    ...
    switch (dim) {
        case 2: {
            ...
            Numerics newtonRaphson2D(gInfo.coorp, gInfo.coor, dataStructure2D.get_iper(), dataStructure2D.get_logfr(), dataStructure2D.get_ndeg(),
                                     dataStructure2D.get_jaret(), gInfo.nu, gInfo.ns, gInfo.np, dataStructure2D.get_pitch(), gInfo.nper, dataStructure2D.isperiph);
        ...
        case 3: {
            ...
            // GeometryHandle.wingBending(100);  // alpha = 0.1
            // GeometryHandle.wingTorsionBending(1); // alpha = 0.05
            GeometryHandle.rotateGeometry(90., 0., 0.0);
            GeometryHandle.translateGeometry(0.0, 1., 0.0);
            ...
            // GeometryHandle.translateGeometry(0.0, 0.1, 0.0);
            ...
            Numerics NewtonRaphson3D(Mesh3D.coorp, Mesh3D.coor, DS3D.get_iper(), DS3D.get_logfr(), DS3D.get_ndeg(), DS3D.get_jaret(),
                                     Mesh3D.nu, Mesh3D.ns, 0, Mesh3D.pitch, Mesh3D.nper, DS3D.isperiph);
